          ...
          {team.map((member, index) => (
            ...
            >
              <div className="group text-center w-full">
                <div className="relative mb-6 overflow-hidden rounded-xl aspect-square w-full">
                  <Image
                  ...
                  <Link
                    ...
                    className="absolute bottom-4 right-4 w-10 h-10 bg-background rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-lg z-10"
                  >
